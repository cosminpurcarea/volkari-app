...
import { Brain, Twitter, Facebook, Instagram, Github, Mail, MapPin, Phone } from 'lucide-react';
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex items-center">
              ...
              <a href="mailto:support@volkari.com" className="hover:text-white">support@volkari.com</a>
            </li>
            <li className="flex items-center">
